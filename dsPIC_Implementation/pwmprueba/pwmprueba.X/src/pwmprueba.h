...
#ifndef RTW_HEADER_pwmprueba_h_
#define RTW_HEADER_pwmprueba_h_
#ifndef pwmprueba_COMMON_INCLUDES_
# define pwmprueba_COMMON_INCLUDES_
#include <string.h>
#include "rtwtypes.h"
#endif                                 /* pwmprueba_COMMON_INCLUDES_ */

#include "pwmprueba_types.h"
#define FCY                            4.0E+7
...
typedef struct {
  int16_T U1CH1;                       /* '<Root>/QEI' */
  int16_T U1CH2;                       /* '<Root>/QEI' */
} B_pwmprueba_T;

/* Real-time Model Data Structure */
struct tag_RTM_pwmprueba_T {
  /*
   * Timing:
...
/* Block signals (auto storage) */
extern B_pwmprueba_T pwmprueba_B;

/* Model entry point functions */
extern void pwmprueba_initialize(void);
extern void pwmprueba_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_pwmprueba_T *const pwmprueba_M;
