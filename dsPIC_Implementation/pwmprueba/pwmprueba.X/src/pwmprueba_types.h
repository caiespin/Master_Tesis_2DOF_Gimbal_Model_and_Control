...
#ifndef RTW_HEADER_pwmprueba_types_h_
#define RTW_HEADER_pwmprueba_types_h_

/* Forward declaration for rtModel */
typedef struct tag_RTM_pwmprueba_T RT_MODEL_pwmprueba_T;

#endif                                 /* RTW_HEADER_pwmprueba_types_h_ */
