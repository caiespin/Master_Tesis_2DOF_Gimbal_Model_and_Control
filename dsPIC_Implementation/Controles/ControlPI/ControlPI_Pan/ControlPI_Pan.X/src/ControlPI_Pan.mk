...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI\ControlPI_Pan\ControlPI_Pan.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI\ControlPI_Pan \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI\ControlPI_Pan\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI\ControlPI_Pan\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI\ControlPI_Pan\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI\ControlPI_Pan\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
