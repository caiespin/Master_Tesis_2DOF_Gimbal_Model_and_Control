...
#ifndef RTW_HEADER_ControlPID_Pan_h_
#define RTW_HEADER_ControlPID_Pan_h_
#ifndef ControlPID_Pan_COMMON_INCLUDES_
# define ControlPID_Pan_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
#include "rtGetInf.h"
...
#endif                                 /* ControlPID_Pan_COMMON_INCLUDES_ */

#include "ControlPID_Pan_types.h"
#define FCY                            4.0E+7
...
struct tag_RTM_ControlPID_Pan_T {
  /*
   * Timing:
...
/* Block signals (auto storage) */
extern B_ControlPID_Pan_T ControlPID_Pan_B;

/* Block states (auto storage) */
extern DW_ControlPID_Pan_T ControlPID_Pan_DW;

/* Model entry point functions */
extern void ControlPID_Pan_initialize(void);
extern void ControlPID_Pan_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_ControlPID_Pan_T *const ControlPID_Pan_M;
 ...
 *
 * '<Root>' : 'ControlPID_Pan'
 * '<S1>'   : 'ControlPID_Pan/MOTOR_DRIVER'
 * '<S2>'   : 'ControlPID_Pan/PI_CONTROL'
 * '<S3>'   : 'ControlPID_Pan/MOTOR_DRIVER/Compare To Zero'
 * '<S4>'   : 'ControlPID_Pan/MOTOR_DRIVER/MODE1'
 * '<S5>'   : 'ControlPID_Pan/MOTOR_DRIVER/PHASE'
 * '<S6>'   : 'ControlPID_Pan/PI_CONTROL/Discrete PID Controller'
 */
#endif                                 /* RTW_HEADER_ControlPID_Pan_h_ */
