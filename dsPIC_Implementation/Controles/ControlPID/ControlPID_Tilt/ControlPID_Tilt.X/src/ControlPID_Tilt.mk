...
#   
MODEL               = ControlPID_Tilt
MODULES             = ControlPID_Tilt_main.c MCHP_UART1_Interrupt.c receive.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE            = ControlPID_Tilt.mk
...
MODELLIB                  = ControlPID_Tiltlib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles\ControlPID\ControlPID_Tilt\ControlPID_Tilt.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles\ControlPID\ControlPID_Tilt \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles\ControlPID\ControlPID_Tilt\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles\ControlPID\ControlPID_Tilt\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles\ControlPID\ControlPID_Tilt\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles\ControlPID\ControlPID_Tilt\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
