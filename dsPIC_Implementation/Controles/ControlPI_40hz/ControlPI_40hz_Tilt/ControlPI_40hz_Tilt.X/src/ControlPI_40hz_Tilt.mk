...
#   
MODEL               = ControlPI_40hz_Tilt
MODULES             = ControlPI_40hz_Tilt_main.c MCHP_UART1_Interrupt.c MCHP_UART2_Interrupt.c receive.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE            = ControlPI_40hz_Tilt.mk
...
MODELLIB                  = ControlPI_40hz_Tiltlib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_40hz\ControlPI_40hz_Tilt\ControlPI_40hz_Tilt.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_40hz\ControlPI_40hz_Tilt \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_40hz\ControlPI_40hz_Tilt\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_40hz\ControlPI_40hz_Tilt\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_40hz\ControlPI_40hz_Tilt\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_40hz\ControlPI_40hz_Tilt\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
