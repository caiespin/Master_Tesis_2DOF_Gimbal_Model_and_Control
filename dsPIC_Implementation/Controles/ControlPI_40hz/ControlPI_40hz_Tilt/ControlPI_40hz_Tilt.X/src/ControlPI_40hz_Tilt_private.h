 ...
 *--------------------------------------------------------------
 *
 * File: ControlPI_40hz_Tilt_private.h
 *
...
#ifndef RTW_HEADER_ControlPI_40hz_Tilt_private_h_
#define RTW_HEADER_ControlPI_40hz_Tilt_private_h_
#include "rtwtypes.h"
...
/* C Function Call declare function as extern */
extern void send_data(unsigned char data[], double contr);
extern void ControlPI_40hz_Tilt_step0(void);
extern void ControlPI_40hz_Tilt_step1(void);

#endif                                 /* RTW_HEADER_ControlPI_40hz_Tilt_private_h_ */
