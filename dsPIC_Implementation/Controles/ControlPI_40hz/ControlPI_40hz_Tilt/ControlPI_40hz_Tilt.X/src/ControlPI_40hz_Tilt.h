...
#ifndef RTW_HEADER_ControlPI_40hz_Tilt_h_
#define RTW_HEADER_ControlPI_40hz_Tilt_h_
#ifndef ControlPI_40hz_Tilt_COMMON_INCLUDES_
# define ControlPI_40hz_Tilt_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
#include "rtGetInf.h"
...
#endif                                 /* ControlPI_40hz_Tilt_COMMON_INCLUDES_ */

#include "ControlPI_40hz_Tilt_types.h"
#define FCY                            4.0E+7
...
} B_ControlPI_40hz_Tilt_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T DiscreteTimeIntegrator_DSTATE;/* '<S2>/Discrete-Time Integrator' */
} DW_ControlPI_40hz_Tilt_T;

/* Real-time Model Data Structure */
struct tag_RTM_ControlPI_40hz_Tilt_T {
  /*
   * Timing:
...
/* Block signals (auto storage) */
extern B_ControlPI_40hz_Tilt_T ControlPI_40hz_Tilt_B;

/* Block states (auto storage) */
extern DW_ControlPI_40hz_Tilt_T ControlPI_40hz_Tilt_DW;

/* Model entry point functions */
extern void ControlPI_40hz_Tilt_initialize(void);
extern void ControlPI_40hz_Tilt_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_ControlPI_40hz_Tilt_T *const ControlPI_40hz_Tilt_M;
 ...
 *
 * '<Root>' : 'ControlPI_40hz_Tilt'
 * '<S1>'   : 'ControlPI_40hz_Tilt/MOTOR_DRIVER'
 * '<S2>'   : 'ControlPI_40hz_Tilt/PI_CONTROL'
 * '<S3>'   : 'ControlPI_40hz_Tilt/MOTOR_DRIVER/Compare To Zero'
 * '<S4>'   : 'ControlPI_40hz_Tilt/MOTOR_DRIVER/Digital Output'
 * '<S5>'   : 'ControlPI_40hz_Tilt/MOTOR_DRIVER/Digital Output1'
 */
#endif                                 /* RTW_HEADER_ControlPI_40hz_Tilt_h_ */
