...
#   
MODEL               = PruebaComReadwTy
MODULES             = MCHP_UART1_Interrupt.c PruebaComReadwTy_main.c receive.c 
MAKEFILE            = PruebaComReadwTy.mk
...
MODELLIB                  = PruebaComReadwTylib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI\PruebaCom\PruebaComTilt\PruebaComReadwTy.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI\PruebaCom\PruebaComTilt \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI\PruebaCom\PruebaComTilt\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI\PruebaCom\PruebaComTilt\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI\PruebaCom\PruebaComTilt\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI\PruebaCom\PruebaComTilt\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
