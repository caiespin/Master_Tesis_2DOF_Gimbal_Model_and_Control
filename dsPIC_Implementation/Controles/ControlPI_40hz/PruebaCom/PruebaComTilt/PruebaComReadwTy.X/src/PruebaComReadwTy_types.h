...
#ifndef RTW_HEADER_PruebaComReadwTy_types_h_
#define RTW_HEADER_PruebaComReadwTy_types_h_

/* Forward declaration for rtModel */
typedef struct tag_RTM_PruebaComReadwTy_T RT_MODEL_PruebaComReadwTy_T;

#endif                                 /* RTW_HEADER_PruebaComReadwTy_types_h_ */
