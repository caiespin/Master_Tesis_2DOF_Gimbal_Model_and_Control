 ...
 *--------------------------------------------------------------
 *
 * File: ControlPI_Pan.h
 *
 * Real-Time Workshop code generated for Simulink model ControlPI_Pan.
 *
 * Model version                        : 1.74
 * Real-Time Workshop file version      : 8.5 (R2013b) 08-Aug-2013
 * Real-Time Workshop file generated on : Wed Sep 30 12:20:55 2015
 * TLC version                          : 8.5 (Aug  6 2013)
 * C source code generated on           : Wed Sep 30 12:20:56 2015
 */

#ifndef RTW_HEADER_ControlPI_Pan_h_
#define RTW_HEADER_ControlPI_Pan_h_
#ifndef ControlPI_Pan_COMMON_INCLUDES_
# define ControlPI_Pan_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
#include "rtGetInf.h"
...
#endif                                 /* ControlPI_Pan_COMMON_INCLUDES_ */

#include "ControlPI_Pan_types.h"
#define FCY                            4.0E+7
...
struct tag_RTM_ControlPI_Pan_T {
  /*
   * Timing:
...
/* Block signals (auto storage) */
extern B_ControlPI_Pan_T ControlPI_Pan_B;

/* Block states (auto storage) */
extern DW_ControlPI_Pan_T ControlPI_Pan_DW;

/* Model entry point functions */
extern void ControlPI_Pan_initialize(void);
extern void ControlPI_Pan_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_ControlPI_Pan_T *const ControlPI_Pan_M;
 ...
 *
 * '<Root>' : 'ControlPI_Pan'
 * '<S1>'   : 'ControlPI_Pan/MOTOR_DRIVER'
 * '<S2>'   : 'ControlPI_Pan/PI_CONTROL'
 * '<S3>'   : 'ControlPI_Pan/MOTOR_DRIVER/Compare To Zero'
 * '<S4>'   : 'ControlPI_Pan/MOTOR_DRIVER/MODE1'
 * '<S5>'   : 'ControlPI_Pan/MOTOR_DRIVER/PHASE'
 */
#endif                                 /* RTW_HEADER_ControlPI_Pan_h_ */
