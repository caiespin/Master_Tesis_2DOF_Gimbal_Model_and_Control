...
#   
MODEL               = ControlPI_Tilt_100hz
MODULES             = ControlPI_Tilt_100hz_main.c MCHP_UART1_Interrupt.c MCHP_UART2_Interrupt.c receive.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE            = ControlPI_Tilt_100hz.mk
...
MODELLIB                  = ControlPI_Tilt_100hzlib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_100hz\ControlPI_Tilt_100hz\ControlPI_Tilt_100hz.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_100hz\ControlPI_Tilt_100hz \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_100hz\ControlPI_Tilt_100hz\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_100hz\ControlPI_Tilt_100hz\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_100hz\ControlPI_Tilt_100hz\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ControlPI_100hz\ControlPI_Tilt_100hz\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
