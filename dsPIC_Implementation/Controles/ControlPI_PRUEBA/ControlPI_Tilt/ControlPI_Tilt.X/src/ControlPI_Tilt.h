 ...
 * Real-Time Workshop file generated on : Wed Sep 30 15:42:46 2015
 * TLC version                          : 8.5 (Aug  6 2013)
 * C source code generated on           : Wed Sep 30 15:42:46 2015
 */

#ifndef RTW_HEADER_ControlPI_Tilt_h_
#define RTW_HEADER_ControlPI_Tilt_h_
#ifndef ControlPI_Tilt_COMMON_INCLUDES_
# define ControlPI_Tilt_COMMON_INCLUDES_
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
#include "rtGetInf.h"
...
#endif                                 /* ControlPI_Tilt_COMMON_INCLUDES_ */

#include "ControlPI_Tilt_types.h"
#define FCY                            4.0E+7
...
struct tag_RTM_ControlPI_Tilt_T {
  /*
   * Timing:
...
/* Block signals (auto storage) */
extern B_ControlPI_Tilt_T ControlPI_Tilt_B;

/* Block states (auto storage) */
extern DW_ControlPI_Tilt_T ControlPI_Tilt_DW;

/* Model entry point functions */
extern void ControlPI_Tilt_initialize(void);
extern void ControlPI_Tilt_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_ControlPI_Tilt_T *const ControlPI_Tilt_M;
 ...
 *
 * '<Root>' : 'ControlPI_Tilt'
 * '<S1>'   : 'ControlPI_Tilt/MOTOR_DRIVER'
 * '<S2>'   : 'ControlPI_Tilt/PI_CONTROL'
 * '<S3>'   : 'ControlPI_Tilt/Video_OSD_Selector'
 * '<S4>'   : 'ControlPI_Tilt/Video_Source_Selector'
 * '<S5>'   : 'ControlPI_Tilt/MOTOR_DRIVER/Compare To Zero'
 * '<S6>'   : 'ControlPI_Tilt/MOTOR_DRIVER/Digital Output'
 * '<S7>'   : 'ControlPI_Tilt/MOTOR_DRIVER/Digital Output1'
 */
#endif                                 /* RTW_HEADER_ControlPI_Tilt_h_ */
