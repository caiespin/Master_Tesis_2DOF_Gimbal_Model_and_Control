...
MODULES             = ControlPI_Tilt_main.c MCHP_UART1_Interrupt.c receive.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Tilt\ControlPI_Tilt.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Tilt \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Tilt\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Tilt\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Tilt\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Tilt\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
