...
#   
MODEL               = ControlPI_Pan
MODULES             = ControlPI_Pan_main.c MCHP_UART1_Interrupt.c MCHP_UART2_Interrupt.c receive.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE            = ControlPI_Pan.mk
...
MODELLIB                  = ControlPI_Panlib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Pan\ControlPI_Pan.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Pan \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Pan\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Pan\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Pan\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\Controles_PI\ControlPI_quiza\ControlPI_Pan\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
