...
#ifndef RTW_HEADER_ControlSM_Tilt_types_h_
#define RTW_HEADER_ControlSM_Tilt_types_h_

/* Forward declaration for rtModel */
typedef struct tag_RTM_ControlSM_Tilt_T RT_MODEL_ControlSM_Tilt_T;

#endif                                 /* RTW_HEADER_ControlSM_Tilt_types_h_ */
