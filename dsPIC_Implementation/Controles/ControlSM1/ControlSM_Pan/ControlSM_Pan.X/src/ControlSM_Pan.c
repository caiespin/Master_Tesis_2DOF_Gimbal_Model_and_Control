...
#include "ControlSM_Pan.h"
#include "ControlSM_Pan_private.h"

/* Block signals (auto storage) */
B_ControlSM_Pan_T ControlSM_Pan_B;

/* Block states (auto storage) */
DW_ControlSM_Pan_T ControlSM_Pan_DW;

/* Real-time model */
RT_MODEL_ControlSM_Pan_T ControlSM_Pan_M_;
RT_MODEL_ControlSM_Pan_T *const ControlSM_Pan_M = &ControlSM_Pan_M_;

/* Model step function for TID0 */
void ControlSM_Pan_step0(void)         /* Sample time: [0.001s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID1 */
void ControlSM_Pan_step1(void)         /* Sample time: [0.025s, 0.0s] */
{
  ...
  /* MCHP_UART_Rx Block for UARTRef 1: <Root>/UART Rx/Outputs */
  {
    {
      int_T i1;
      uint8_T *y0 = &ControlSM_Pan_B.U1Rx[0] ;
      for (i1 = 0; i1 < 128 ; i1++) {
  ...
  ControlSM_Pan_B.CFunctionCall = Receive_wTz(
    &ControlSM_Pan_B.U1Rx[0]
    );
   ...
   *  Product: '<S2>/Product'
   */
  rtb_Product3 = ControlSM_Pan_DW.DiscreteTimeIntegrator_DSTATE * 50500.0 +
    ControlSM_Pan_B.CFunctionCall;
   ...
   */
  rtb_Product3 = (-(ControlSM_Pan_B.CFunctionCall * 50500.0) + -(rtb_Product3 *
    6500.0)) * 0.00058234;
  ...
  if (rtb_Product_0 <= 3997U) {
    ControlSM_Pan_B.Saturation = rtb_Product_0;
  } else {
    ControlSM_Pan_B.Saturation = 3997U;
  }
  ...
  ControlSM_Pan_DW.DiscreteTimeIntegrator_DSTATE += 0.025 *
    ControlSM_Pan_B.CFunctionCall;

  /* Update for S-Function (MCHP_PWM): '<S1>/PWM' */
  P1DC1 = ControlSM_Pan_B.Saturation;  /* Period for Channel 1 */
  ...
  /* MCHP_UART_Tx Block for UARTRef 2: <Root>/UART Tx/Outputs */
  {
    ...
    {
      int_T i1;
      uint8_T *u0 = &ControlSM_Pan_B.U1Rx[0] ;
      for (i1 = 0; i1 < 128 ; i1++) {
        if (Tmp != 0) {
...
void ControlSM_Pan_step(int_T tid)
{
  switch (tid) {
   case 0 :
    ControlSM_Pan_step0();
...
void ControlSM_Pan_initialize(void)
{
  /* Registration code */
  ...
  /* block I/O */
  (void) memset(((void *) &ControlSM_Pan_B), 0,
                sizeof(B_ControlSM_Pan_T));

  /* states (dwork) */
  (void) memset((void *)&ControlSM_Pan_DW, 0,
                sizeof(DW_ControlSM_Pan_T));
