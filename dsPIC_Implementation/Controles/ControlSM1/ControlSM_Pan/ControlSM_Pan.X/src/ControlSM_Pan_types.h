...
#ifndef RTW_HEADER_ControlSM_Pan_types_h_
#define RTW_HEADER_ControlSM_Pan_types_h_

/* Forward declaration for rtModel */
typedef struct tag_RTM_ControlSM_Pan_T RT_MODEL_ControlSM_Pan_T;

#endif                                 /* RTW_HEADER_ControlSM_Pan_types_h_ */
