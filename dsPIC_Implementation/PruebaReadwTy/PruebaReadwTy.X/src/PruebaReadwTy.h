...
#ifndef RTW_HEADER_PruebaReadwTy_h_
#define RTW_HEADER_PruebaReadwTy_h_
#ifndef PruebaReadwTy_COMMON_INCLUDES_
# define PruebaReadwTy_COMMON_INCLUDES_
#include <string.h>
#include "rtwtypes.h"
#endif                                 /* PruebaReadwTy_COMMON_INCLUDES_ */

#include "PruebaReadwTy_types.h"
#define FCY                            4.0E+7
...
struct tag_RTM_PruebaReadwTy_T {
  /*
   * Timing:
...
/* Block signals (auto storage) */
extern B_PruebaReadwTy_T PruebaReadwTy_B;

/* Model entry point functions */
extern void PruebaReadwTy_initialize(void);
extern void PruebaReadwTy_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_PruebaReadwTy_T *const PruebaReadwTy_M;
 ...
 * '<Root>' : 'PruebaReadwTy'
 */
#endif                                 /* RTW_HEADER_PruebaReadwTy_h_ */
