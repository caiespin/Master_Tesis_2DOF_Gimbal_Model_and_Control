 ...
 *--------------------------------------------------------------
 *
 * File: PruebaReadwTy.c
 *
 * Real-Time Workshop code generated for Simulink model PruebaReadwTy.
 *
 * Model version                        : 1.57
 * Real-Time Workshop file version      : 8.5 (R2013b) 08-Aug-2013
 * Real-Time Workshop file generated on : Tue Apr 28 14:19:21 2015
 * TLC version                          : 8.5 (Aug  6 2013)
 * C source code generated on           : Tue Apr 28 14:19:22 2015
 */

#include "PruebaReadwTy.h"
#include "PruebaReadwTy_private.h"

/* Block signals (auto storage) */
B_PruebaReadwTy_T PruebaReadwTy_B;

/* Real-time model */
RT_MODEL_PruebaReadwTy_T PruebaReadwTy_M_;
RT_MODEL_PruebaReadwTy_T *const PruebaReadwTy_M = &PruebaReadwTy_M_;

/* Model step function for TID0 */
void PruebaReadwTy_step0(void)         /* Sample time: [0.001s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID1 */
void PruebaReadwTy_step1(void)         /* Sample time: [0.025s, 0.0s] */
{
  /* MCHP_UART_Rx Block for UARTRef 1: <Root>/UART Rx/Outputs */
  {
    {
      int_T i1;
      uint8_T *y0 = &PruebaReadwTy_B.U1Rx[0] ;
      for (i1 = 0; i1 < 128 ; i1++) {
  ...
  send_wTy(
           &PruebaReadwTy_B.U1Rx[0]
           );
}

/* Model step wrapper function for compatibility with a static main program */
void PruebaReadwTy_step(int_T tid)
{
  switch (tid) {
   case 0 :
    PruebaReadwTy_step0();
...
void PruebaReadwTy_initialize(void)
{
  /* Registration code */

  /* block I/O */
  (void) memset(((void *) &PruebaReadwTy_B), 0,
                sizeof(B_PruebaReadwTy_T));
