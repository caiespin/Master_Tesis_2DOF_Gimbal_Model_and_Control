...
#   
MODEL               = PruebaReadwTy
MODULES             = MCHP_UART1_Interrupt.c PruebaReadwTy_main.c receive.c 
MAKEFILE            = PruebaReadwTy.mk
...
MODELLIB                  = PruebaReadwTylib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaReadwTy\PruebaReadwTy.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaReadwTy \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaReadwTy\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaReadwTy\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaReadwTy\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaReadwTy\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
