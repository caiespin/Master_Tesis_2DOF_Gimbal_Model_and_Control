...
#ifndef RTW_HEADER_VectorNavRead_types_h_
#define RTW_HEADER_VectorNavRead_types_h_

/* Forward declaration for rtModel */
typedef struct tag_RTM_VectorNavRead_T RT_MODEL_VectorNavRead_T;

#endif                                 /* RTW_HEADER_VectorNavRead_types_h_ */
