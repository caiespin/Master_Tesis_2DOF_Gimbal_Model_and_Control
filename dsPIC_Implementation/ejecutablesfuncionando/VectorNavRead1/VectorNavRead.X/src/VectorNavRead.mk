...
#   
MODEL               = VectorNavRead
MODULES             = MCHP_UART1_Interrupt.c MCHP_UART2_Interrupt.c VectorNavRead_main.c receive.c 
MAKEFILE            = VectorNavRead.mk
...
MODELLIB                  = VectorNavReadlib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\VectorNavRead\VectorNavRead.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\VectorNavRead \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\VectorNavRead\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\VectorNavRead\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\VectorNavRead\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\VectorNavRead\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
