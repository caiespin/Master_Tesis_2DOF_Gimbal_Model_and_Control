...
#ifndef RTW_HEADER_PruebaComMain_h_
#define RTW_HEADER_PruebaComMain_h_
#ifndef PruebaComMain_COMMON_INCLUDES_
# define PruebaComMain_COMMON_INCLUDES_
#include <string.h>
#include "rtwtypes.h"
#endif                                 /* PruebaComMain_COMMON_INCLUDES_ */

#include "PruebaComMain_types.h"
#define FCY                            4.0E+7
...
struct tag_RTM_PruebaComMain_T {
  /*
   * Timing:
...
/* Block signals (auto storage) */
extern B_PruebaComMain_T PruebaComMain_B;

/* Model entry point functions */
extern void PruebaComMain_initialize(void);
extern void PruebaComMain_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_PruebaComMain_T *const PruebaComMain_M;
 ...
 * '<Root>' : 'PruebaComMain'
 */
#endif                                 /* RTW_HEADER_PruebaComMain_h_ */
