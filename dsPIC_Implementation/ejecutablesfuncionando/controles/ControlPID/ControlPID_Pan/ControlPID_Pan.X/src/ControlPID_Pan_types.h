...
#ifndef RTW_HEADER_ControlPID_Pan_types_h_
#define RTW_HEADER_ControlPID_Pan_types_h_

/* Forward declaration for rtModel */
typedef struct tag_RTM_ControlPID_Pan_T RT_MODEL_ControlPID_Pan_T;

#endif                                 /* RTW_HEADER_ControlPID_Pan_types_h_ */
