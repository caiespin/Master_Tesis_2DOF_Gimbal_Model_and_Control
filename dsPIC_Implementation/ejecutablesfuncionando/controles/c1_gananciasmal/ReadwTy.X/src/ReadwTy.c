...
void ReadwTy_step1(void)               /* Sample time: [0.025s, 0.0s] */
{
   ...
   *  Product: '<S2>/Product'
   */
  rtb_Sum = 9.0 * ReadwTy_B.CFunctionCall +
  ...
  if (rtb_Sum_0 <= 3997U) {
    ReadwTy_B.Saturation = rtb_Sum_0;
  } else {
  ...
  ReadwTy_DW.DiscreteTimeIntegrator_DSTATE += 3.0 * ReadwTy_B.CFunctionCall;
