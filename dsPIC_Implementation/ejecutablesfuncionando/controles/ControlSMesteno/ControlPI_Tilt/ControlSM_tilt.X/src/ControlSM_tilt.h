 ...
 * '<S2>'   : 'ControlSM_tilt/PI_CONTROL'
 * '<S3>'   : 'ControlSM_tilt/MOTOR_DRIVER/Compare To Zero'
 * '<S4>'   : 'ControlSM_tilt/MOTOR_DRIVER/Digital Output'
 * '<S5>'   : 'ControlSM_tilt/MOTOR_DRIVER/Digital Output1'
 */
