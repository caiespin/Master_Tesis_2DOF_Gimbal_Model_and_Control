...
#   
MODEL               = ControlSM_tilt
MODULES             = ControlSM_tilt_main.c MCHP_UART1_Interrupt.c receive.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE            = ControlSM_tilt.mk
...
MODELLIB                  = ControlSM_tiltlib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ejecutablesfuncionando\controles\ControlSM\ControlPI_Tilt\ControlSM_tilt.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ejecutablesfuncionando\controles\ControlSM\ControlPI_Tilt \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ejecutablesfuncionando\controles\ControlSM\ControlPI_Tilt\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ejecutablesfuncionando\controles\ControlSM\ControlPI_Tilt\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ejecutablesfuncionando\controles\ControlSM\ControlPI_Tilt\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ejecutablesfuncionando\controles\ControlSM\ControlPI_Tilt\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
