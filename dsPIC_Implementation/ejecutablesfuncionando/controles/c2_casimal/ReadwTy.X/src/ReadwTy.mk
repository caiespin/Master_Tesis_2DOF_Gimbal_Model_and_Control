...
#   
MODEL               = ReadwTy
MODULES             = MCHP_UART1_Interrupt.c ReadwTy_main.c receive.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE            = ReadwTy.mk
...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ReadwTy\ReadwTy.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ReadwTy \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ReadwTy\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ReadwTy\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ReadwTy\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\ReadwTy\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
