...
#ifndef RTW_HEADER_PWMtiltboard_h_
#define RTW_HEADER_PWMtiltboard_h_
#ifndef PWMtiltboard_COMMON_INCLUDES_
# define PWMtiltboard_COMMON_INCLUDES_
#include <string.h>
#include "rtwtypes.h"
#endif                                 /* PWMtiltboard_COMMON_INCLUDES_ */

#include "PWMtiltboard_types.h"
#define FCY                            4.0E+7
...
/* Block signals (auto storage) */
extern B_PWMtiltboard_T PWMtiltboard_B;

/* Model entry point functions */
extern void PWMtiltboard_initialize(void);
extern void PWMtiltboard_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_PWMtiltboard_T *const PWMtiltboard_M;
 ...
 *
 * '<Root>' : 'PWMtiltboard'
 * '<S1>'   : 'PWMtiltboard/MODE1'
 * '<S2>'   : 'PWMtiltboard/PHASE'
 */
#endif                                 /* RTW_HEADER_PWMtiltboard_h_ */
