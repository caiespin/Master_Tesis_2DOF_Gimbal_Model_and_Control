...
#ifndef RTW_HEADER_PruebaVectornav_h_
#define RTW_HEADER_PruebaVectornav_h_
#ifndef PruebaVectornav_COMMON_INCLUDES_
# define PruebaVectornav_COMMON_INCLUDES_
#include <string.h>
#include "rtwtypes.h"
#endif                                 /* PruebaVectornav_COMMON_INCLUDES_ */

#include "PruebaVectornav_types.h"
#define FCY                            4.0E+7
...
struct tag_RTM_PruebaVectornav_T {
  /*
   * Timing:
...
/* Block signals (auto storage) */
extern B_PruebaVectornav_T PruebaVectornav_B;

/* Model entry point functions */
extern void PruebaVectornav_initialize(void);
extern void PruebaVectornav_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_PruebaVectornav_T *const PruebaVectornav_M;
 ...
 *
 * '<Root>' : 'PruebaVectornav'
 */
#endif                                 /* RTW_HEADER_PruebaVectornav_h_ */
