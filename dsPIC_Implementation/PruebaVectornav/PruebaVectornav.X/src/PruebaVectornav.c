 ...
 *--------------------------------------------------------------
 *
 * File: PruebaVectornav.c
 *
 * Real-Time Workshop code generated for Simulink model PruebaVectornav.
 *
 * Model version                        : 1.31
 * Real-Time Workshop file version      : 8.5 (R2013b) 08-Aug-2013
 * Real-Time Workshop file generated on : Wed Apr 22 13:06:31 2015
 * TLC version                          : 8.5 (Aug  6 2013)
 * C source code generated on           : Wed Apr 22 13:06:32 2015
 */

#include "PruebaVectornav.h"
#include "PruebaVectornav_private.h"

/* Block signals (auto storage) */
B_PruebaVectornav_T PruebaVectornav_B;

/* Real-time model */
RT_MODEL_PruebaVectornav_T PruebaVectornav_M_;
RT_MODEL_PruebaVectornav_T *const PruebaVectornav_M = &PruebaVectornav_M_;

/* Model step function for TID0 */
void PruebaVectornav_step0(void)       /* Sample time: [0.001s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID1 */
void PruebaVectornav_step1(void)       /* Sample time: [0.01s, 0.0s] */
{
  /* MCHP_UART_Rx Block for UARTRef 1: <Root>/UART Rx/Outputs */
  {
    {
      int_T i1;
      uint8_T *y0 = &PruebaVectornav_B.U1Rx[0] ;
      for (i1 = 0; i1 < 128 ; i1++) {
  ...
  /* MCHP_UART_Tx Block for UARTRef 2: <Root>/UART Tx/Outputs */
  {
    ...
    {
      int_T i1;
      uint8_T *u0 = &PruebaVectornav_B.U1Rx[0] ;
      for (i1 = 0; i1 < 128 ; i1++) {
        if ((Tmp != 0) && (u0[i1] != 0)) {
...
void PruebaVectornav_step(int_T tid)
{
  switch (tid) {
   case 0 :
    PruebaVectornav_step0();
    break;

   case 1 :
    PruebaVectornav_step1();
    break;
...
void PruebaVectornav_initialize(void)
{
  /* Registration code */

  /* block I/O */
  (void) memset(((void *) &PruebaVectornav_B), 0,
                sizeof(B_PruebaVectornav_T));
