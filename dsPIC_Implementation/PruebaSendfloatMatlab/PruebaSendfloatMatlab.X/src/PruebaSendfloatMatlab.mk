...
#   
MODEL               = PruebaSendfloatMatlab
MODULES             = MCHP_UART1_Interrupt.c PruebaSendfloatMatlab_main.c sendfloat.c 
MAKEFILE            = PruebaSendfloatMatlab.mk
...
MODELLIB                  = PruebaSendfloatMatlablib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
#
ADD_INCLUDES = \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaSendfloatMatlab\PruebaSendfloatMatlab.X\src \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaSendfloatMatlab \
	-IC:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaSendfloatMatlab\Source \
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaSendfloatMatlab\Source/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaSendfloatMatlab\Source/%.cpp
	$(CC) -c $(CPPFLAGS) $<
...
%.o : C:\Users\Maestria01\Dropbox\TESIS_Maestria\Matlab\mplabtoolbox\PruebaSendfloatMatlab\Source/%.s
	$(CC) -c -mcpu=$(PIC_REF) $< -Wa,-g
