...
#ifndef RTW_HEADER_serial_tilt_types_h_
#define RTW_HEADER_serial_tilt_types_h_

/* Forward declaration for rtModel */
typedef struct tag_RTM_serial_tilt_T RT_MODEL_serial_tilt_T;

#endif                                 /* RTW_HEADER_serial_tilt_types_h_ */
