...
#ifndef RTW_HEADER_comuserialmainboard_h_
#define RTW_HEADER_comuserialmainboard_h_
#ifndef comuserialmainboard_COMMON_INCLUDES_
# define comuserialmainboard_COMMON_INCLUDES_
#include <string.h>
#include "rtwtypes.h"
#endif                                 /* comuserialmainboard_COMMON_INCLUDES_ */

#include "comuserialmainboard_types.h"
#define FCY                            4.0E+7
...
} B_comuserialmainboard_T;

/* Real-time Model Data Structure */
struct tag_RTM_comuserialmainboard_T {
  /*
   * Timing:
...
/* Block signals (auto storage) */
extern B_comuserialmainboard_T comuserialmainboard_B;

/* Model entry point functions */
extern void comuserialmainboard_initialize(void);
extern void comuserialmainboard_step(int_T tid);

/* Real-time Model object */
extern RT_MODEL_comuserialmainboard_T *const comuserialmainboard_M;
 ...
 *
 * '<Root>' : 'comuserialmainboard'
 */
#endif                                 /* RTW_HEADER_comuserialmainboard_h_ */
