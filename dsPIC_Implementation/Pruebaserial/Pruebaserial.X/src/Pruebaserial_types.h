...
#ifndef RTW_HEADER_Pruebaserial_types_h_
#define RTW_HEADER_Pruebaserial_types_h_

/* Forward declaration for rtModel */
typedef struct tag_RTM_Pruebaserial_T RT_MODEL_Pruebaserial_T;

#endif                                 /* RTW_HEADER_Pruebaserial_types_h_ */
